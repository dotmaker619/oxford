...
export const prepareVariantsWithOptions = variants =>
  variants?.map(variant => prepareVariantWithOptions(variant))

export const prepareVariantWithOptions = variant => {
...
// Find the option corresponding to the name
//
export const optionsByName = (options, name) =>
...
export const formatSelectedOptions = selectedOptions => {
  return selectedOptions.reduce((obj, current) => {
